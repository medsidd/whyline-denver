...
# Materialize all allowlisted marts as tables.
HOT_MARTS = {
...
# Empty: mart_gtfs_stops is now exported from BigQuery via nightly-bq (sync-export)
# and loaded from GCS parquet like all other marts.
GTFS_LOADED_MARTS: set[str] = set()
